...
mixin _$Status {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Status);
  }
...
extension StatusPatterns on Status {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      ...
      case StatusLoading() when loading != null:
        return loading(_that);
      case StatusSuccess() when success != null:
        return success(_that);
      case StatusFailure() when failure != null:
        return failure(_that);
      case StatusAuthFailure() when authFailure != null:
...
class StatusInitial extends Status {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is StatusInitial);
  }
...
class StatusLoading extends Status {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is StatusLoading);
  }
...
class StatusSuccess extends Status {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is StatusSuccess);
  }
...
class StatusFailure extends Status {
  ...
  $StatusFailureCopyWith<StatusFailure> get copyWith =>
      _$StatusFailureCopyWithImpl<StatusFailure>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StatusFailure &&
...
/// @nodoc
abstract mixin class $StatusFailureCopyWith<$Res>
    implements $StatusCopyWith<$Res> {
  factory $StatusFailureCopyWith(
          StatusFailure value, $Res Function(StatusFailure) _then) =
      _$StatusFailureCopyWithImpl;
  @useResult
...
class StatusAuthFailure extends Status {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $StatusAuthFailureCopyWith<StatusAuthFailure> get copyWith =>
      _$StatusAuthFailureCopyWithImpl<StatusAuthFailure>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is StatusAuthFailure &&
            (identical(other.errorMessage, errorMessage) ||
                other.errorMessage == errorMessage));
  }
...
/// @nodoc
abstract mixin class $StatusAuthFailureCopyWith<$Res>
    implements $StatusCopyWith<$Res> {
  factory $StatusAuthFailureCopyWith(
          StatusAuthFailure value, $Res Function(StatusAuthFailure) _then) =
      _$StatusAuthFailureCopyWithImpl;
  @useResult
  $Res call({String errorMessage});
}
