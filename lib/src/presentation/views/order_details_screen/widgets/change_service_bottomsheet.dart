...
class ChangeServiceBottomsheet extends StatefulWidget {
  const ChangeServiceBottomsheet({super.key, this.bagId, required this.serviceName, required this.serviceImage, required this.serviceColor, required this.isQuickOrder});
  final String? bagId;
  ...
  Widget alreadyAssignedWidget({required String serviceImage, required String serviceName, required Color serviceColor}) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            'This bag has already been scanned and assigned to a service. Do you want to reassign it?',
