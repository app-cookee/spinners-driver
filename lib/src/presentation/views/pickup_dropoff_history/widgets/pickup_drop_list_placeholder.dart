...
class PickupDropListPlaceholder extends StatelessWidget {
  const PickupDropListPlaceholder({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(shrinkWrap: true,
      ...
      itemBuilder: (context, index) => Container(
        padding: EdgeInsets.only(top: 9.dp, bottom: 0.dp),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    _shimmerBox(width: 113.dp, height: 12.dp),
                    const Spacer(),
