            ...
            child: SingleChildScrollView(
              child: BlocBuilder<AuthBloc, AuthState>(
                builder: (context, authState) {
                      //  if (authState.profileAuthStatus is StatusLoading) {
                      //         return Padding(
                  ...
                  return Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsetsGeometry.only(left: 16.dp),
                        child: Skeletonizer(enabled: (authState.profileAuthStatus
                                            is StatusInitial ||
                                        authState.profileAuthStatus
                                            is StatusLoading),
                          child: ProfileUserDetail(
                            profileImage: authState.appUser?.photo ?? '',
                            active: authState.appUser?.active ?? false,
                            firstName:
                                (authState.appUser?.firstName.isNotEmpty ?? false)
                                    ? authState.appUser!.firstName
                                    : "Driver",
                            lastName: authState.appUser?.lastName,
                            phone: (authState.appUser?.phoneNumber.isNotEmpty ??
                                    false)
                                ? authState.appUser!.phoneNumber
                                : "",
                          ),
                        ),
                      ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Skeletonizer(enabled: (authState.profileAuthStatus
                                            is StatusInitial ||
                                        authState.profileAuthStatus
                                            is StatusLoading),
                                  child:      (authState.appUser?.vehicleNumber!=""&&authState.appUser?.vehicleNumber!=null)? Text(
                                    'Vehicle No : ${authState.appUser?.vehicleNumber??""}',
