...
abstract class OrderEvent with _$OrderEvent {
     const factory OrderEvent.getOrdersList({required int limit,required int skip,required String filter,required bool expressOnly, double? latitude, double? longitude, String? searchText,String? pickupTo, String? deliveryTo}) = _GetOrdersList;
       const factory OrderEvent.paginateOrdersList({required int skip, required int limit,required String filter,required bool expressOnly, double? latitude, double? longitude, String? searchText,required String pickupTo,required String deliveryTo}) = _PaginateOrdersList;
  ...
  const factory OrderEvent.getServicesList({required int limit, required int skip,String? serviceMenuId}) = _GetServicesList;
