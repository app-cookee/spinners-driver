...
abstract class OrderEvent with _$OrderEvent {
     const factory OrderEvent.getOrdersList({required int limit,required int skip,required String filter,required bool expressOnly, double? latitude, double? longitude, String? searchText, String? pickupFrom, String? pickupTo, String? deliveryFrom, String? deliveryTo}) = _GetOrdersList;
